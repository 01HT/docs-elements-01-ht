...
Нет никаких пробных режимов и "котов в мешке". Вы всегда можете воспользоваться элементом и оценить его. Исходный код большинства элементов находится в публичных репозиториях GitHub.
