...
В руководстве размещена информация о том, как пользоваться приложением Elements, подробности работы функционала, правила и рекомендации для авторов элементов, а также ответы на часто задаваемые вопросы.
...
* [Выплата вознаграждения](/guide/remuneration/)

#### Разделы

* [Регистрация и вход](/guide/sign-in/)
* [Аккаунт 01HT](/guide/account/)
...
* [Настройки договора](/guide/contract/)
* [Настройки выплат](/guide/payout/)
